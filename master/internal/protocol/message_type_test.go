...
func TestMessageType_IsValid(t *testing.T) {
	tests := []struct {
		...
		{name: "NarrativeSceneImage_ReturnsFalse_Removed", t: MessageType("narrative.scene_image"), want: false},
		{name: "CharacterReviewResult_ReturnsTrue", t: MessageTypeCharacterReviewResult, want: true},
		{name: "TermsAccept_ReturnsTrue", t: MessageTypeTermsAccept, want: true},
