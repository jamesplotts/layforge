...
- campaign.md: YAML front matter with id (a short lowercase-hyphenated slug), title, level_range (e.g. "1-3"), pvp_policy (one of pve_only, pvp_allowed, pvp_with_consent — default pve_only unless the description implies otherwise), maturity_tier ("standard" unless the description clearly implies otherwise), image_maturity_tier ("family_friendly" unless the description clearly implies otherwise), shared_knowledge ("strict" unless the description implies otherwise), tone (a short list of adjectives), author ("AI-generated"). Body: a few paragraphs of overview prose plus a "## Hooks" section.
