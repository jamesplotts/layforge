...
**[layforge.org](https://layforge.org)** is the project's public site: a
...
[`registry/README.md`](registry/README.md)) — no central server your game
...
| Provider | `-llm-provider` | Needs |
|---|---|---|
| [Ollama](https://ollama.com) (self-hosted) | `ollama` (default) | `-llm-url` only, no API key |
| [Anthropic](https://www.anthropic.com) (Claude) | `anthropic` | `-llm-api-key` |
| OpenAI (ChatGPT) | `openai` | `-llm-api-key` |
| [OpenRouter](https://openrouter.ai) | `openrouter` | `-llm-api-key` |
| [Z.ai](https://z.ai) | `zai` | `-llm-api-key` |
...
[`master/README.md`](master/README.md#running) for the full flag
reference.
...
[layforge.org](https://layforge.org) (`registry/`, a separate standalone
...
- **Repository**: [https://github.com/jamesplotts/layforge](https://github.com/jamesplotts/layforge)
- **Issues**: [https://github.com/jamesplotts/layforge/issues](https://github.com/jamesplotts/layforge/issues)
